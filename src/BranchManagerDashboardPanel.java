...
public class BranchManagerDashboardPanel extends JPanel {
    private final MainFrame mainFrame;
    private final SessionManager sessionManager;
    private final JLabel headerLabel;

    public BranchManagerDashboardPanel(MainFrame mainFrame, SessionManager sessionManager) {
        ...
        addDashboardButton(buttonPanel, "View Branch Vehicles");
        addDashboardButton(buttonPanel, "Add / Update Vehicle");
        addDashboardButton(buttonPanel, "View Reservations");
        addDashboardButton(buttonPanel, "Branch Summary");
    ...
    public void refreshHeader() {
        headerLabel.setText("Branch Manager Dashboard - " + sessionManager.getSelectedUser());
    }
